...
def print_welcome_message() -> None:
    ...
    print(f"{Fore.YELLOW}Modularized Version 1.1.0{Style.RESET_ALL}")
    ...
    def get_advanced_midi_options(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not (20 <= options["bpm"] <= 300):  # Reasonable range
                print(f"{Fore.YELLOW}Warning: BPM {options['bpm']} is outside the typical range (20-300).{Style.RESET_ALL}")
        ...
        try:
            ...
            print(f"{Fore.RED}Invalid velocity, using {options['base_velocity']}.{Style.RESET_ALL}")
